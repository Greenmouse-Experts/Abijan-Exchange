                                                ...
                                                @if ($users->count() > 0)
                                                    @foreach ($users as $item)
                                                        <tr>
                                                            ...
                                                            @endphp
                                                            <th scope="row">{{ !is_null(request()->query('user')) ? ((int) request()->query('user') * 10) + $loop->iteration - 10 : $loop->iteration}}</th>
                                                            <td>
                                                                @if ($true == true)
                                                            ...
                                                            <td>
                                                                <a data-placement="top" title="View Role" style="cursor: pointer" href="{{ route('users.show',$item->id) }}">
                                                                    <i class=" ti-eye "></i>
                                                                </a>
                                                                {{-- <a data-placement="top" title="Edit Role" style="cursor: pointer" href="{{ route('users.edit',$item->id) }}">
