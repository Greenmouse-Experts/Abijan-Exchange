                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text">
                                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                        onclick="Seepassword()" viewBox="0 0 512 512"
                                                        class="visiblePassword" height="1em" width="1em"
...
=======
                    <div
                        ...
                        <div
                            class="position-relative bg-gradient-primary h-100 m-3 px-5 border-radius-lg d-flex flex-column justify-content-center overflow-hidden">
                            <div class="container"><a href="{{ route('home') }}" target="_blank"
                                    rel="noopener noreferrer"><img src="{{ URL::asset('assets/images/logoo.png') }}"
