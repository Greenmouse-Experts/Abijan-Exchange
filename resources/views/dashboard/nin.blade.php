                                ...
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        ...
                                        <ul class="nav nav-pills custom_bootstrap_nav">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#nairadiv" data-toggle="tab">Verify NIN</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <div class="tab-content">
                                <div class="white_card_body tab-pane fade active show" id="nairadiv">
                                    <div class="exchange_widget">
                                        <form name="mySettform" id="mySettform" method="POST" action="{{route('verify.nin')}}"  autocomplete="off">
                                            @csrf
                                            <div class="form-group thirdver">
                                                <label>Virtual NIN number</label>
                                                <input type="text" value="" name="nin_num"
                                                    class="form-control" id="nin_num">
                                                    <small>Hint: Virtual NIN can be generated via the NIMC mobile App or via USSD. Use <a href="https://nimc.gov.ng/nin-tokenization/" target="_blank">this</a> to generate Virtual NIN to be verified.<br>
                                                        Specify SEAMFIX Agent ID: 951641
                                                    </small>
                                            ...
                                            <button type="submit" name="" id="" class="btn_1 w-100 ">Verify NIN <span class="loadingText fa fa-spinner fa-spin fa-2x" style="display:none;float:right;" id="loadingText_sett"></span></button><input type="hidden" id="prof" name="prof" value="questions">
                                        </form>
                                    </div>
                                </div>
